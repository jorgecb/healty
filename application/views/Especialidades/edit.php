...
<?php echo form_hidden('IdEspecialidad',$result->IdEspecialidad) ?>
                                    ...
                                    <div class="controls"><textarea id="descripcion" name="descripcion" class="input-xlarge" row="3"><?php echo $result->descripcion ?></textarea>
                                    ...
                                    <div class="controls"><input id="foto" type="text" name="foto" value="<?php echo $result->foto ?>"  class="input-xlarge"  />
