...
<?php echo form_hidden('IdEnfermedades',$result->IdEnfermedades) ?>
                                    ...
                                    <div class="controls"><input id="IdEspecialidad" type="dropdown" name="IdEspecialidad" value="<?php echo $result->IdEspecialidad ?>"  />
